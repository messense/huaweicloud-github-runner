...
async function startEcsInstance(label, githubRegistrationToken) {
    ...
    const userData = `#!/bin/bash
        ...
        curl -O -L https://github.com/actions/runner/releases/download/v2.279.0/actions-runner-linux-$RUNNER_ARCH-2.279.0.tar.gz
        tar xzf ./actions-runner-linux-$RUNNER_ARCH-2.279.0.tar.gz
        rm ./actions-runner-linux-$RUNNER_ARCH-2.279.0.tar.gz
